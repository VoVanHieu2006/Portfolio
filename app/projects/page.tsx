    ...
    <main className="min-h-screen bg-background">
      ...
      <PageFrame>
        <section className="mx-auto w-full max-w-6xl px-4 py-16">
          <p className="text-sm uppercase tracking-[0.3em] text-cyan-600 dark:text-cyan-300">{t.projects.eyebrow}</p>
          <h1 className="mt-4 text-4xl font-semibold text-foreground">{t.projects.title}</h1>
          <p className="mt-4 max-w-2xl text-muted-foreground">{t.projects.description}</p>
          <div className="mt-10">
            {projects.length ? (
